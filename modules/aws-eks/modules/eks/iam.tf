...
resource "aws_iam_role_policy_attachment" "cluster-AmazonRoute53AutoNamingFullAccess" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonRoute53AutoNamingFullAccess"
  role       = "${aws_iam_role.cluster.name}"
}

resource "aws_iam_role_policy_attachment" "cluster-K8sExternalDNSPolicy" {
...
resource "aws_iam_role_policy_attachment" "node-K8sExternalDNSPolicy" {
  policy_arn = "${aws_iam_policy.external-dns-policy.arn}"
  role       = "${aws_iam_role.node.name}"
}
